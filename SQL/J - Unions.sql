...
-- A union allows us to combine the result set of two or more individual select statements for the union to worl, however , the number , order and 
-- data type of the column in the selet statements must match
